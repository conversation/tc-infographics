...
function ministerProfileView (selectedMinister, insertDiv) {
        ...
        $("#" + insertDiv + " .profileBasics").append("<div class='profileDetail ministerAgeFaction'><div id='ministerAge'><span class='profileHeading'>Age:</span><span class='profileValue'>" + ministerAge + "</div><div id='ministerFaction'><span class='profileHeading'>" + factionLabel + ":</span><span class='profileValue'>" + ministerFaction + "</div></div>");        
        ...
        if (ministerSeatType == "MP") {
            ...
            $("#" + insertDiv + " .profileSeat .ministerSeatDetails").append("<div class='profileDetail'><span class='chartHeading'>2013 election result for " + ministerSeat + ": </span></div>");
...
jQuery(document).ready(function($) {
    ...
    jQuery('.profileDetailButton').on('click', function(e)  {
        ...
        //console.log("Portfolio Scroll Position: " + scrollPosition);
    ...
    jQuery('.profile-photo').on('click', function(e)  {
        ...
        // set scroll position
        //scrollPosition = $('body, html', parent.document).scrollTop();
        //scrollPosition = $(window, parent.document).scrollTop();
